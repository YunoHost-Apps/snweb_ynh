...
**Version incluse :** 3.66.0~ynh1 *(:warning: Il s'agit de la branche `update_upstream`. La [branche `master`](https://github.com/YunoHost-Apps/snweb_ynh/tree/master) utilisée dans le catalogue est actuellement en 3.39.1\~ynh1.)*
